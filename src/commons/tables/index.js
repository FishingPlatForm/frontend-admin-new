                ...
                if (record.Status != 1) {
                    return (
                        <div style={{ display: "flex", alignItems: 'center' }}>
                            ...
                            <Popconfirm
                                placement="left"
                                title={record?.Exposure === 1 ? "是否取消曝光" : "是否曝光"}
                                description={record?.Exposure === 1 ? "是否取消曝光" : "是否曝光"}
                                onConfirm={() => btnClick(record?.Exposure === 1 ? "offExposure" : "exposure", record)}
                                okText="确定"
                                cancelText="取消"
                            >
                                <Button type="primary">{record?.Exposure === 1 ? "取消曝光" : "曝光"}</Button>
                            </Popconfirm>
                        </div>
